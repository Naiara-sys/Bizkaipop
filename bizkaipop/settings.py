...
SECRET_KEY = 'django-insecure-)4bx*itix@2)ne369v-(86dzq)7f*-m(hlcj0*f9+gaapwnxlv'

#SECURIDAD AVISO: no correr con debug activado en produccion
DEBUG = config('DEBUG', default=True, cast=bool)

ALLOWED_HOSTS = config('ALLOWED_HOSTS', dafault='django-insecure-)4bx*itix@2)ne369v-(86dzq)7f*-m(hlcj0*f9+gaapwnxlv')
